...
![img](https://cnblogs.gree.com/static/img2018/blog/1354564/201906/1354564-20190625095157144-577104035.png)
...
- :移动到行尾。</li><listyle="list−style:inherit!important">g:移动到行尾。</li><listyle="list−style:inherit!important">g: 移动光标所在屏幕行行尾。
- n|: 把光标移到递n列上。
- nG: 到文件第n行。
- :n<cr> 移动到第n行。
- :$<cr> 移动到最后一行。
...
[这里是](http://cnblogs.gree.com/jiqingwu/admin/vim-quick-edit.html) 滇狐总结的比较高级的vi技巧。
...
让vim 正确处理文件格式和文件编码，有赖于 [~/.vimrc的正确配置](http://cnblogs.gree.com/jiqingwu/admin/vimrc.html)
